...
func (f *fakeTwitch) route() {
	...
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/users", "login=notfound2", httpmock.NewStringResponder(200, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/users", "login=servererror", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/users", "login=decodeerror", httpmock.NewStringResponder(200, "}"))
	...
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/search/categories", "query=notfound2", httpmock.NewStringResponder(404, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/search/categories", "query=servererror", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/search/categories", "query=decodeerror", httpmock.NewStringResponder(200, "}"))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/search/categories", "query=requesterror", httpmock.NewErrorResponder(errTestBadRequest))

	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/games", "name=PLAYERUNKNOWN%27s+BATTLEGROUNDS", httpmock.NewStringResponder(200, `{"data": [{"id": "287491", "name": "PLAYERUNKNOWN's BATTLEGROUNDS"}]}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/games", "id=287491", httpmock.NewStringResponder(200, `{"data": [{"id": "287491", "name": "PLAYERUNKNOWN's BATTLEGROUNDS"}]}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/games", "name=notfound", httpmock.NewStringResponder(200, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/games", "name=servererror", httpmock.NewStringResponder(500, ""))
	...
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/streams", "user_login=notfound", httpmock.NewStringResponder(404, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/streams", "user_login=notfound2", httpmock.NewStringResponder(200, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/streams", "user_login=servererror", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/streams", "user_login=decodeerror", httpmock.NewStringResponder(200, "}"))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/streams", "user_login=requesterror", httpmock.NewErrorResponder(errTestBadRequest))

	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/channels", "broadcaster_id=1234", httpmock.NewStringResponder(200, `{"data": [{"broadcaster_id": "1234", "broadcaster_name": "foobar", "game_id": "58730284", "game_name": "PUBG MOBILE", "title": "This is the title."}]}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/channels", "broadcaster_id=404", httpmock.NewStringResponder(404, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/channels", "broadcaster_id=444", httpmock.NewStringResponder(200, `{"data": []}`))
	f.mt.RegisterResponderWithQuery("GET", "https://api.twitch.tv/helix/channels", "broadcaster_id=500", httpmock.NewStringResponder(500, ""))
	...
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/bans", "broadcaster_id=404&moderator_id=3141&user_id=666", httpmock.NewStringResponder(404, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/bans", "broadcaster_id=418&moderator_id=3141&user_id=666", httpmock.NewStringResponder(418, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/bans", "broadcaster_id=500&moderator_id=3141&user_id=666", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/bans", "broadcaster_id=777&moderator_id=3141&user_id=666", httpmock.NewErrorResponder(errTestBadRequest))

	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=1234&color=%239146FF", httpmock.NewStringResponder(200, ``))
	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=401&color=%239146FF", httpmock.NewStringResponder(401, ``))
	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=404&color=%239146FF", httpmock.NewStringResponder(404, ``))
	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=418&color=%239146FF", httpmock.NewStringResponder(418, ``))
	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=500&color=%239146FF", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("PUT", "https://api.twitch.tv/helix/chat/color", "user_id=777&color=%239146FF", httpmock.NewErrorResponder(errTestBadRequest))

	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=1234&moderator_id=3141&message_id=somemessage", httpmock.NewStringResponder(200, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=401&moderator_id=3141&message_id=somemessage", httpmock.NewStringResponder(401, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=404&moderator_id=3141&message_id=somemessage", httpmock.NewStringResponder(404, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=418&moderator_id=3141&message_id=somemessage", httpmock.NewStringResponder(418, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=500&moderator_id=3141&message_id=somemessage", httpmock.NewStringResponder(500, ""))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=777&moderator_id=3141&message_id=somemessage", httpmock.NewErrorResponder(errTestBadRequest))

	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=1234&moderator_id=3141", httpmock.NewStringResponder(200, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=401&moderator_id=3141", httpmock.NewStringResponder(401, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=404&moderator_id=3141", httpmock.NewStringResponder(404, ``))
	f.mt.RegisterResponderWithQuery("DELETE", "https://api.twitch.tv/helix/moderation/chat", "broadcaster_id=418&moderator_id=3141", httpmock.NewStringResponder(418, ``))
