...
const userAgentsURL = "https://unpkg.com/user-agents@2.1.151/dist/user-agents.json"
...
func getEntries() []*entry {
	...
	var entries []*entry
	must.NilError(jsonx.DecodeSingle(resp.Body, &entries))
	return entries
}
...
func main() {
	...
	// Since we only care about the user agents themselves, group them back together.
	...
	for userAgent, weight := range entries {
		choices = append(choices, choice{userAgent, max(1, int(weight/minWeight))})
	}
