...
CREATE INDEX link_permits_channel_id_idx ON link_permits (channel_id);
CREATE INDEX link_permits_name_idx on link_permits (name);
CREATE INDEX link_permits_expires_at_idx on link_permits (expires_at);
