...
func (o *Channel) GetAutoreplies() AutoreplySlice {
	if o == nil {
		return nil
	}

	return o.R.GetAutoreplies()
}
...
func (o *Channel) GetCommandInfos() CommandInfoSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCommandInfos()
}
...
func (o *Channel) GetCommandLists() CommandListSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCommandLists()
}
...
func (o *Channel) GetCustomCommands() CustomCommandSlice {
	if o == nil {
		return nil
	}

	return o.R.GetCustomCommands()
}
...
func (o *Channel) GetHighlights() HighlightSlice {
	if o == nil {
		return nil
	}

	return o.R.GetHighlights()
}
...
func (o *Channel) GetQuotes() QuoteSlice {
	if o == nil {
		return nil
	}
...
func (o *Channel) GetRepeatedCommands() RepeatedCommandSlice {
	if o == nil {
		return nil
	}

	return o.R.GetRepeatedCommands()
}
...
func (o *Channel) GetScheduledCommands() ScheduledCommandSlice {
	if o == nil {
		return nil
	}

	return o.R.GetScheduledCommands()
}
...
func (o *Channel) GetVariables() VariableSlice {
	if o == nil {
		return nil
	}

	return o.R.GetVariables()
}
...
func (channelL) LoadAutoreplies(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`autoreplies`),
		qm.WhereIn(`autoreplies.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadCommandInfos(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`command_infos.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadCommandLists(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`command_lists.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadCustomCommands(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`custom_commands.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadHighlights(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`highlights`),
		qm.WhereIn(`highlights.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadQuotes(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`quotes`),
		qm.WhereIn(`quotes.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadRepeatedCommands(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`repeated_commands.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadScheduledCommands(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		...
		qm.WhereIn(`scheduled_commands.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (channelL) LoadVariables(ctx context.Context, e boil.ContextExecutor, singular bool, maybeChannel any, mods queries.Applicator) error {
	var slice []*Channel
	var object *Channel
	...
	query := NewQuery(
		qm.From(`variables`),
		qm.WhereIn(`variables.channel_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if !cached {
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(channelPrimaryKeyColumns) == 0 {
				return errors.New("models: unable to upsert channels, could not build conflict column list")
			}
