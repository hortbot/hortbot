...
func (o *Highlight) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (highlightL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeHighlight any, mods queries.Applicator) error {
	var slice []*Highlight
