...
func (o *CustomCommand) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (r *customCommandR) GetChannel() *Channel {
	if r == nil {
		return nil
	}
...
func (o *CustomCommand) GetCommandInfo() *CommandInfo {
	if o == nil {
		return nil
	}
...
func (r *customCommandR) GetCommandInfo() *CommandInfo {
	if r == nil {
		return nil
	}
...
func (customCommandL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomCommand any, mods queries.Applicator) error {
...
func (customCommandL) LoadCommandInfo(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCustomCommand any, mods queries.Applicator) error {
	var slice []*CustomCommand
	var object *CustomCommand
	...
	query := NewQuery(
		...
		qm.WhereIn(`command_infos.custom_command_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *CustomCommand) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	return CustomCommandExists(ctx, exec, o.ID)
}
