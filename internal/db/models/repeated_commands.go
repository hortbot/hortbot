// Code generated by SQLBoiler 4.17.0 (https://github.com/volatiletech/sqlboiler). DO NOT EDIT.
...
func (o RepeatedCommandSlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	sql := "DELETE FROM \"repeated_commands\" WHERE " +
		strmangle.WhereInClause(string(dialect.LQ), string(dialect.RQ), 1, repeatedCommandPrimaryKeyColumns, len(o))
