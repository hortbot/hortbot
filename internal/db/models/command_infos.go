...
func (o *CommandInfo) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (o *CommandInfo) GetCommandList() *CommandList {
	if o == nil {
		return nil
	}

	return o.R.GetCommandList()
}
...
func (o *CommandInfo) GetCustomCommand() *CustomCommand {
	if o == nil {
		return nil
	}

	return o.R.GetCustomCommand()
}
...
func (o *CommandInfo) GetRepeatedCommand() *RepeatedCommand {
	if o == nil {
		return nil
	}

	return o.R.GetRepeatedCommand()
}
...
func (o *CommandInfo) GetScheduledCommand() *ScheduledCommand {
	if o == nil {
		return nil
	}

	return o.R.GetScheduledCommand()
}
...
func (commandInfoL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCommandInfo any, mods queries.Applicator) error {
...
// loaded structs of the objects. This is for an N-1 relationship.
func (commandInfoL) LoadCommandList(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCommandInfo any, mods queries.Applicator) error {
	var slice []*CommandInfo
	var object *CommandInfo
...
// loaded structs of the objects. This is for an N-1 relationship.
func (commandInfoL) LoadCustomCommand(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCommandInfo any, mods queries.Applicator) error {
	var slice []*CommandInfo
	var object *CommandInfo
...
func (commandInfoL) LoadRepeatedCommand(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCommandInfo any, mods queries.Applicator) error {
	var slice []*CommandInfo
	var object *CommandInfo
...
// loaded structs of the objects. This is for a 1-1 relationship.
func (commandInfoL) LoadScheduledCommand(ctx context.Context, e boil.ContextExecutor, singular bool, maybeCommandInfo any, mods queries.Applicator) error {
	var slice []*CommandInfo
	var object *CommandInfo
