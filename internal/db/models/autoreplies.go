...
func (o *Autoreply) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (autoreplyL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAutoreply any, mods queries.Applicator) error {
	var slice []*Autoreply
