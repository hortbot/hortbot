...
func (o *Quote) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (quoteL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeQuote any, mods queries.Applicator) error {
	var slice []*Quote
	var object *Quote
