...
func (o *Variable) GetChannel() *Channel {
	if o == nil {
		return nil
	}
...
func (variableL) LoadChannel(ctx context.Context, e boil.ContextExecutor, singular bool, maybeVariable any, mods queries.Applicator) error {
	var slice []*Variable
	var object *Variable
